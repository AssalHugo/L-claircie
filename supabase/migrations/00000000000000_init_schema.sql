-- ============================================================
-- Migration initiale — schema de base de L Eclaircie
--
-- Reprend civic_tech.sql, rendu idempotent, pour que le dossier
-- supabase/migrations/ soit AUTOSUFFISANT.
--
-- Sans cette migration, "npx supabase db push" sur un projet neuf echouait
-- des la premiere migration : civic_tech.sql vit a la racine du depot et
-- n est jamais joue par le CLI Supabase.
--
-- Toutes les operations sont conditionnelles : no-op sur une base existante.
-- ============================================================

CREATE TABLE IF NOT EXISTS "dim_groupe" (
...
CREATE TABLE IF NOT EXISTS "dim_depute" (
  "id" SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS "dim_depute_groupe_historique" (
  "id" SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS "dim_promesse" (
  "id" SERIAL PRIMARY KEY,
  "groupe_id" int NOT NULL,
...
CREATE TABLE IF NOT EXISTS "fact_scrutin" (
  "id" SERIAL PRIMARY KEY,
...
CREATE TABLE IF NOT EXISTS "fact_vote_individuel" (
  "id" SERIAL PRIMARY KEY,
  "depute_id" int NOT NULL,
...
CREATE TABLE IF NOT EXISTS "cache_score_groupe" (
  "id" SERIAL PRIMARY KEY,
  "groupe_id" int NOT NULL,
  "theme_id" int,
...
CREATE TABLE IF NOT EXISTS "cache_score_depute" (
  "id" SERIAL PRIMARY KEY,
  "depute_id" int NOT NULL,
  "theme_id" int,
  "score_0_100" smallint NOT NULL,
...
CREATE TABLE IF NOT EXISTS "user_alertes" (
  "id" SERIAL PRIMARY KEY,
...
CREATE INDEX IF NOT EXISTS "idx_groupe_sigle" ON "dim_groupe" ("sigle");

CREATE INDEX IF NOT EXISTS "idx_depute_uid_an" ON "dim_depute" ("uid_an");

CREATE INDEX IF NOT EXISTS "idx_depute_groupe" ON "dim_depute" ("groupe_id");

CREATE INDEX IF NOT EXISTS "idx_depute_circo" ON "dim_depute" ("departement", "num_circo");

CREATE INDEX IF NOT EXISTS "idx_histo_depute_date" ON "dim_depute_groupe_historique" ("depute_id", "date_debut");

CREATE INDEX IF NOT EXISTS "idx_promesse_groupe_theme" ON "dim_promesse" ("groupe_id", "theme_id");

CREATE INDEX IF NOT EXISTS "idx_promesse_statut" ON "dim_promesse" ("statut");

CREATE INDEX IF NOT EXISTS "idx_scrutin_uid_an" ON "fact_scrutin" ("uid_an");

CREATE INDEX IF NOT EXISTS "idx_scrutin_date" ON "fact_scrutin" ("date_scrutin");

CREATE INDEX IF NOT EXISTS "idx_scrutin_etl_queue" ON "fact_scrutin" ("llm_traite", "pertinent");

CREATE UNIQUE INDEX IF NOT EXISTS "uq_vote_depute_scrutin" ON "fact_vote_individuel" ("depute_id", "scrutin_id");

CREATE INDEX IF NOT EXISTS "idx_vote_scrutin_groupe" ON "fact_vote_individuel" ("scrutin_id", "groupe_id_au_moment_du_vote");

CREATE INDEX IF NOT EXISTS "idx_vote_groupe" ON "fact_vote_individuel" ("groupe_id_au_moment_du_vote");

CREATE UNIQUE INDEX IF NOT EXISTS "uq_classification_scrutin_promesse" ON "llm_classification" ("scrutin_id", "promesse_id");

CREATE INDEX IF NOT EXISTS "idx_classif_statut" ON "llm_classification" ("statut_publication", "statut_validation");

CREATE INDEX IF NOT EXISTS "idx_classif_confidence" ON "llm_classification" ("confidence_score");

CREATE UNIQUE INDEX IF NOT EXISTS "uq_score_groupe_theme" ON "cache_score_groupe" ("groupe_id", "theme_id");

CREATE INDEX IF NOT EXISTS "idx_score_groupe" ON "cache_score_groupe" ("groupe_id");

CREATE UNIQUE INDEX IF NOT EXISTS "uq_score_depute_theme" ON "cache_score_depute" ("depute_id", "theme_id");

CREATE INDEX IF NOT EXISTS "idx_score_depute" ON "cache_score_depute" ("depute_id");

CREATE INDEX IF NOT EXISTS "idx_score_delta" ON "cache_score_depute" ("delta_vs_groupe");

CREATE INDEX IF NOT EXISTS "idx_pref_circo" ON "user_preferences" ("departement", "num_circo");

CREATE UNIQUE INDEX IF NOT EXISTS "uq_alerte_user_groupe_theme" ON "user_alertes" ("user_id", "groupe_id", "theme_id");

CREATE INDEX IF NOT EXISTS "idx_etl_log_type_date" ON "etl_run_log" ("run_type", "created_at");

CREATE INDEX IF NOT EXISTS "idx_etl_log_statut" ON "etl_run_log" ("statut");
...
DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_dim_depute_groupe_id') THEN
    ALTER TABLE "dim_depute" ADD CONSTRAINT "fk_dim_depute_groupe_id" FOREIGN KEY ("groupe_id") REFERENCES "dim_groupe" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_dim_depute_groupe_historique_depute_id') THEN
    ALTER TABLE "dim_depute_groupe_historique" ADD CONSTRAINT "fk_dim_depute_groupe_historique_depute_id" FOREIGN KEY ("depute_id") REFERENCES "dim_depute" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_dim_depute_groupe_historique_groupe_id') THEN
    ALTER TABLE "dim_depute_groupe_historique" ADD CONSTRAINT "fk_dim_depute_groupe_historique_groupe_id" FOREIGN KEY ("groupe_id") REFERENCES "dim_groupe" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_dim_promesse_groupe_id') THEN
    ALTER TABLE "dim_promesse" ADD CONSTRAINT "fk_dim_promesse_groupe_id" FOREIGN KEY ("groupe_id") REFERENCES "dim_groupe" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_dim_promesse_theme_id') THEN
    ALTER TABLE "dim_promesse" ADD CONSTRAINT "fk_dim_promesse_theme_id" FOREIGN KEY ("theme_id") REFERENCES "dim_theme" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_fact_vote_individuel_depute_id') THEN
    ALTER TABLE "fact_vote_individuel" ADD CONSTRAINT "fk_fact_vote_individuel_depute_id" FOREIGN KEY ("depute_id") REFERENCES "dim_depute" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_fact_vote_individuel_scrutin_id') THEN
    ALTER TABLE "fact_vote_individuel" ADD CONSTRAINT "fk_fact_vote_individuel_scrutin_id" FOREIGN KEY ("scrutin_id") REFERENCES "fact_scrutin" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_fact_vote_individuel_groupe_id_au_moment_du_vote') THEN
    ALTER TABLE "fact_vote_individuel" ADD CONSTRAINT "fk_fact_vote_individuel_groupe_id_au_moment_du_vote" FOREIGN KEY ("groupe_id_au_moment_du_vote") REFERENCES "dim_groupe" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_llm_classification_scrutin_id') THEN
    ALTER TABLE "llm_classification" ADD CONSTRAINT "fk_llm_classification_scrutin_id" FOREIGN KEY ("scrutin_id") REFERENCES "fact_scrutin" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_llm_classification_promesse_id') THEN
    ALTER TABLE "llm_classification" ADD CONSTRAINT "fk_llm_classification_promesse_id" FOREIGN KEY ("promesse_id") REFERENCES "dim_promesse" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_cache_score_groupe_groupe_id') THEN
    ALTER TABLE "cache_score_groupe" ADD CONSTRAINT "fk_cache_score_groupe_groupe_id" FOREIGN KEY ("groupe_id") REFERENCES "dim_groupe" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_cache_score_groupe_theme_id') THEN
    ALTER TABLE "cache_score_groupe" ADD CONSTRAINT "fk_cache_score_groupe_theme_id" FOREIGN KEY ("theme_id") REFERENCES "dim_theme" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_cache_score_depute_depute_id') THEN
    ALTER TABLE "cache_score_depute" ADD CONSTRAINT "fk_cache_score_depute_depute_id" FOREIGN KEY ("depute_id") REFERENCES "dim_depute" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_cache_score_depute_theme_id') THEN
    ALTER TABLE "cache_score_depute" ADD CONSTRAINT "fk_cache_score_depute_theme_id" FOREIGN KEY ("theme_id") REFERENCES "dim_theme" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_user_alertes_groupe_id') THEN
    ALTER TABLE "user_alertes" ADD CONSTRAINT "fk_user_alertes_groupe_id" FOREIGN KEY ("groupe_id") REFERENCES "dim_groupe" ("id");
  END IF;
END $$;

DO $$ BEGIN
  IF NOT EXISTS (SELECT 1 FROM pg_constraint WHERE conname = 'fk_user_alertes_theme_id') THEN
    ALTER TABLE "user_alertes" ADD CONSTRAINT "fk_user_alertes_theme_id" FOREIGN KEY ("theme_id") REFERENCES "dim_theme" ("id");
  END IF;
END $$;
